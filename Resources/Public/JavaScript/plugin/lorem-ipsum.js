...
const ICON_SVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M5 2C4.4 2 4 2.4 4 3v14c0 .6.4 1 1 1h10c.6 0 1-.4 1-1V6l-4-4H5zm6 1l3 3h-3V3zM6.5 9h7c.3 0 .5.2.5.5s-.2.5-.5.5h-7C6.2 10 6 9.8 6 9.5S6.2 9 6.5 9zm0 2.5h5c.3 0 .5.2.5.5s-.2.5-.5.5h-5c-.3 0-.5-.2-.5-.5s.2-.5.5-.5zm0 2.5h6c.3 0 .5.2.5.5s-.2.5-.5.5h-6c-.3 0-.5-.2-.5-.5s.2-.5.5-.5z"/></svg>';
  ...
  init() {
    ...
    editor.ui.componentFactory.add('loremIpsum', (locale) => {
      ...
      button.on('execute', () => {
        ...
        const countInput = dialog.querySelector('[data-field="count"]');
        ...
        function insert() {
          ...
          editor.model.change((writer) => {
            ...
            for (let i = 0; i < count; i++) {
              ...
              writer.insertText(LOREM_PARAGRAPHS[i % LOREM_PARAGRAPHS.length], paragraph);
